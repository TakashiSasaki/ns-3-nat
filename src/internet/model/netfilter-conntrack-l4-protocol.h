...
class Packet;
  ...
  class NetfilterConntrackL4Protocol : public RefCountBase {
    ...
    /**
      ...
      */
      virtual bool PacketToTuple (Ptr<Packet>, NetfilterConntrackTuple&) { return false; };
    ...
    /**
      ...
      */
      virtual bool InvertTuple (NetfilterConntrackTuple& inverse, NetfilterConntrackTuple& orig) { return false; };
      ...
      /**
        ...
        */
      uint16_t GetL4Protocol() { return m_l4Protocol; };
      ...
      /**
        ...
        */
      void SetL4Protocol(uint8_t protocol) { m_l4Protocol = protocol; };
